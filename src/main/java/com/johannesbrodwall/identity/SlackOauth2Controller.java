...
public class SlackOauth2Controller extends Oauth2Controller {

    private static Logger logger = LoggerFactory.getLogger(SlackOauth2Controller.class);

    public SlackOauth2Controller(String providerName) {
        super(providerName);
    }

    @Override
    protected Oauth2Configuration getOauth2Configuration() throws IOException, HttpConfigurationException {
        try {
            ...
            throw new HttpConfigurationException(providerName, Optional.of("https://api.slack.com/apps"), null, e);
        }
    }
