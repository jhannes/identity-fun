...
public class OpenIdConnectController {
    public static class HttpConfigurationException extends HttpActionException {
    ...
    public String getToken(
        ...
        logger.debug("Token response: {}", response.toJson());
        setTokenResponse.accept(response);
